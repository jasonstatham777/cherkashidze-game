...
function buildGameOverMenu() {
    ...
    const scoreResultText = this.add.text(0, -50, '', {
        fontSize: '18px',
        fill: '#ffffff',
        align: 'center'
    }).setOrigin(0.5).setName('scoreResultText');
    const restartBtn = this.add.text(0, 30, 'Перезапуск', {
        fontSize: '24px',
        fill: '#00ff00'
    }).setOrigin(0.5).setInteractive();
    const shopBtn = this.add.text(0, 90, 'Магазин', {
        fontSize: '24px',
        fill: '#ffff00'
    }).setOrigin(0.5).setInteractive();
...
function buildShopMenu() {
    ...
    const title = this.add.text(0, -220, 'МАГАЗИН', {
        fontSize: '28px',
        fill: '#ffff00'
    }).setOrigin(0.5);
    const bananasText = this.add.text(0, -180, '', {
        fontSize: '20px',
        fill: '#ffffff'
    }).setOrigin(0.5).setName('bananasText');
    const shieldInfo = this.add.text(-160, -120, '', {
        fontSize: '16px',
        fill: '#87CEEB',
        align: 'left'
    }).setOrigin(0, 0).setName('shieldInfo');
    const shieldBtn = this.add.text(120, -110, 'Купить', {
        fontSize: '18px',
        fill: '#00ff00',
        backgroundColor: '#333',
        padding: {
    ...
    const magnetInfo = this.add.text(-160, -40, '', {
        fontSize: '16px',
        fill: '#FFB6C1',
        align: 'left'
    }).setOrigin(0, 0).setName('magnetInfo');
    const magnetBtn = this.add.text(120, -30, 'Купить', {
        fontSize: '18px',
        fill: '#00ff00',
        backgroundColor: '#333',
        padding: {
    ...
    const scoreX2Info = this.add.text(-160, 40, '', {
        fontSize: '16px',
        fill: '#FFD700',
        align: 'left'
    }).setOrigin(0, 0).setName('scoreX2Info');
    const scoreX2Btn = this.add.text(120, 50, 'Купить', {
        fontSize: '18px',
        fill: '#00ff00',
        backgroundColor: '#333',
        padding: {
    ...
    const backBtn = this.add.text(0, 200, 'Назад', {
        fontSize: '24px',
        fill: '#ff4444'
    }).setOrigin(0.5).setInteractive();
